								...
								<div class="card-body">
									...
									<form:form modelAttribute="template" method="post"
										...
										<div class="form-group row">
											<label for="templateName" class="col-lg-2 col-xl-2">Template Name
												<span class="required text-danger">*</span>
											</label>
											<div class="col-lg-6 col-xl-6">
												<form:input type="text" class="form-control" id="templateName"
													path="templateName" placeholder="" />
											</div>
										</div>
										<div class="form-group row">
											<label for="templateDescription" class="col-lg-2 col-xl-2">Template Description</label>
											<div class="col-lg-6 col-xl-6">
												<form:input type="text" class="form-control" id="templateDescription"
													path="templateDescription" placeholder="" />
										...
										<div class="form-group row">
											<label for="weekdays" class="col-lg-2 col-xl-2">Week Days<span class="required text-danger">*</span>
											</label>
											<div class="col-lg-6 col-xl-6">
												<div class="checkbox-group required">
													<label class="checkbox-inline"> <form:checkbox
															path="weekdays" id="weekdays" value="sunday" />Sunday
													</label> <label class="checkbox-inline"> <form:checkbox
															path="weekdays" id="weekdays" value="monday" />Monday
													</label> <label class="checkbox-inline"> <form:checkbox
															path="weekdays" id="weekdays" value="tuesday" />Tuesday
													</label>
												</div>
											</div>
										</div>
