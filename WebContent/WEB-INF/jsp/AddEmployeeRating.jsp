...
<body id="page-top" class="sidebar-toggled">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item "><a class="nav-link"
				href="employeeRatingConfiguration"> <i class="fa fa-star"></i> <span>EmployeeRating</span>
			</a></li>
						...
						<div class="col-xl-12 col-lg-12">
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<form:form modelAttribute="ratingDetails" method="post"
										action="submitRating">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6 col-xl-6">
												<form:select type="text" class="form-control custom-select"
													id="empId" path="empId" placeholder="">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#empId").change(function() {
				...
				var element = document.getElementById("empId").value;
				$.ajax({
				    type: "GET",
				    url:"employeeFirstName?empId="+element,
				    async: true,
				    dataType: "text",
