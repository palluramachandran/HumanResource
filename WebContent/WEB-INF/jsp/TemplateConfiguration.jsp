										...
										<c:forEach var="t" items="${templates}">
											<tr>
												...
												<td class="text-center"><a
													href="editTemplate?id=${t.id}"><i
														class="fa fa-edit text-info"></i></a>&nbsp;&nbsp;
												<a href="deleteTemplate?id=${t.id}"><i
														class="fa fa-trash text-danger"></i></a></td>
												<td><c:out value="${t.wotName}" /></td>
												<td><c:out value="${t.workDaysString}" /></td>
												<td><c:out value="${t.startTime}" /></td>
												<td><c:out value="${t.endTime}" /></td>
