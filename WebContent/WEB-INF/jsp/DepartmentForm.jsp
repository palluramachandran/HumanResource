...
<!DOCTYPE html>
<!-- saved from url=(0083)file:///C:/Users/Pallavi/Desktop/Project%20HTMLS/HomeV10-%20DepartmentAddition.html -->
<html lang="en">
<head>
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12 mb-4">
							<div class="card shadow mb-4 h-100">
								...
								<!-- Card Body -->
								<div class="card-body">
									<form:form modelAttribute="department" method="post" action="submitDepartment">
										...
										<div class="row form-group">
											...
											<div class="col-lg-8 col-xl-8">
												<div class="form-check">
													<form:radiobutton path="active" id="active" value="true"/> <label
														class="checkbox-inline" for="active"> Active </label>
													<form:radiobutton  path="active" id="inactive" value="false"/> <label 
														class="checkbox-inline"	for="inactive"> Inactive </label>
												</div>
											</div>
										</div>
