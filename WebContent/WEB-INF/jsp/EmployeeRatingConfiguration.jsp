			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="text-info col-sm-4">
						<c:out  value="${addMsg}"></c:out>
						</div>
						<div class="text-primary col-sm-4">
						<c:out  value="${updateMsg}"></c:out>
						</div>
						...
						<c:out  value="${deleteMsg}"></c:out>
							...
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable"
									...
									<tbody>
										<c:forEach var="e" items="${ratingDetails}">
											<tr>
												...
												<td class="text-center"><a
													href="editRating?empId=${e.empId}"><i
														class="fa fa-edit text-info"></i></a></td>
												<td class="text-center"><a
													href="deleteRating?empId=${e.empId}"><i
